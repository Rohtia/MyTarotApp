...
var question = localStorage.input;
...
var presentCardName = document.getElementById("presentName");
var futureRead = document.getElementById("futureMeaning");
var futureCardName = document.getElementById("futureName");
var pastImg = document.getElementById("pastCardImg");
...
function shuffle() {
	...
	getCard(cardsDrawn);
	//put selected card details in an array
...
function getCard(cards) {
	for (var i = 0; i < cards; i++) {
		...
		var cardNum = Math.floor(Math.random() * 78);
		hand.push(cardNum);

		//check if repeat card is drawn
		for (var j = 0; j < (hand.length - 1); j++) {
			// if card is the same, get rid of and decrement i to draw an extra card
			if (cardNum === hand[j]) {
